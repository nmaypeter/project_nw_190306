from SeedSelection_NaiveGreedySCS import *
                        ...
                        for distribution_type in dis_sequence:
                            for pps in pps_seq:
                                ...
                                for sample_count, sample_seed_set in enumerate(seed_set_sequence):
                                    print('@ mngscsic evaluation @ data_set_name = ' + data_set_name + ', dis = ' + str(distribution_type) + ', wpiwp = ' + str(wpiwp) +
                                ...
                                path1 = 'result/mngscsic_pps' + str(pps) + '_dis' + str(distribution_type) + '_wpiwp' * wpiwp
                                if not os.path.isdir(path1):
                                    os.mkdir(path1)
                                path = 'result/mngscsic_pps' + str(pps) + '_dis' + str(distribution_type) + '_wpiwp' * wpiwp + '/' + data_set_name + '_' + product_name
                                if not os.path.isdir(path):
                                    os.mkdir(path)
                                fw = open(path + '/' + 'b' + str(bud) + '_i' + str(sample_number) + '.txt', 'w')
                                fw.write('mngscsic, pp_strategy = ' + str(pps) + ', total_budget = ' + str(bud) + ', dis = ' + str(distribution_type) + ', wpiwp = ' + str(wpiwp) + '\n' +
