        ...
        for i in set(self.graph_dict.keys()):
            ...
            if temp_mg > 0:
                for k in range(self.num_product):
                    mg = round(temp_mg * self.product_list[k][0] * self.pw_list[k] / (self.product_list[0][0] * self.pw_list[0]), 4)
                    celf_ep = [k, i, mg, 0]
...
if __name__ == '__main__':
    ...
    ssngpw = SeedSelectionNGPW(graph_dict, seed_cost_dict, product_list, product_weight_list, monte_carlo)
