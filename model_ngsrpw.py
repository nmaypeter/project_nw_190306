from SeedSelection_NaiveGreedyRatioPW import *
                ...
                for cm in cm_seq:
                    ...
                    for prod_setting in prod_setting_seq:
                        for prod_setting2 in prod_setting2_seq:
                            ...
                            ssngrpw_main = SeedSelectionNGRPW(graph_dict, seed_cost_dict, product_list, product_weight_list, monte_carlo)
                            ...
                            for sample_count in range(sample_number):
                                ...
                                celf_sequence = ssngrpw_main.generateCelfSequenceR()
                                ...
                                while len(temp_sequence) != 0:
                                    ...
                                    print('@ mngsrpwic seed selection @ data_set_name = ' + data_set_name + '_' + cas_model + ', dis = ' + str(distribution_type) + ', wpiwp = ' + str(wpiwp) +
                                    ...
                                    while now_budget < begin_budget and mep_i_node != '-1':
                                        ...
                                        if mep_flag == seed_set_length:
                                            ...
                                            if mg_seed_ratio_g > 0:
                                                celf_ep_g = (mep_k_prod, mep_i_node, mg_seed_ratio_g, ep_flag)
                            ...
                            for bud in range(1, total_budget + 1):
                                ...
                                for pps in pps_seq:
                                    ...
                                    for sample_count, sample_seed_set in enumerate(seed_set_sequence[bud - 1]):
                                        print('@ mngsrpwic evaluation @ data_set_name = ' + data_set_name + '_' + cas_model + ', dis = ' + str(distribution_type) + ', wpiwp = ' + str(wpiwp) +
                                    ...
                                    path1 = 'result/mngsrpwic_pps' + str(pps) + '_dis' + str(distribution_type) + '_wpiwp' * wpiwp
                                    if not os.path.isdir(path1):
                                        os.mkdir(path1)
                                    path = 'result/mngsrpwic_pps' + str(pps) + '_dis' + str(distribution_type) + '_wpiwp' * wpiwp + '/' + data_set_name + '_' + cas_model + '_' + product_name
                                    if not os.path.isdir(path):
                                        os.mkdir(path)
                                    fw = open(path + '/b' + str(bud) + '_i' + str(sample_number) + '.txt', 'w')
                                    fw.write('mngsrpwic, pp_strategy = ' + str(pps) + ', total_budget = ' + str(bud) + ', dis = ' + str(distribution_type) + ', wpiwp = ' + str(wpiwp) + '\n' +
