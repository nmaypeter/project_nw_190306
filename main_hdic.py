                ...
                for prod_setting2 in prod_setting2_seq:
                    ...
                    for bud in range(begin_budget, total_budget + 1):
                        ...
                        for sample_count in range(sample_number):
                            print("@ mhdic seed selection @ data_set_name = " + data_set_name + ", wpiwp = " + str(wpiwp) +
                        ...
                        for distribution_type in dis_sequence:
                            for pps in pps_seq:
                                ...
                                for sample_count, sample_seed_set in enumerate(seed_set_sequence):
                                    print("@ mhdic evaluation @ data_set_name = " + data_set_name + ", dis = " + str(distribution_type) + ", wpiwp = " + str(wpiwp) +
                                ...
                                if not os.path.isdir(path1):
                                    os.mkdir(path1)
                                path = "result/mhdic_pps" + str(pps) + "_dis" + str(distribution_type) + "_wpiwp" * wpiwp + "/" + data_set_name + "_" + product_name
